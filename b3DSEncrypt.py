                            ...
                            if (exefs_len[0] > 0):
                                        ...
                                        if exefs_filename[0] == b".code\x00\x00\x00":
                                            ...
                                            if (datalenM > 0):
                                                for i in range(datalenM):
                                                    ...
                                                    print("\rPartition %1d ExeFS: Encrypting: %8s... %4d / %4d mb..." % (
                                                    p, exefs_filename[0], i, datalenM + 1), end="")
                                            if (datalenB > 0):
                                                g.write(exefsctrmode2C.decrypt(exefsctrmode.encrypt(f.read(datalenB))))
                                            print("\rPartition %1d ExeFS: Encrypting: %8s... %4d / %4d mb... Done!" % (
                                            p, exefs_filename[0], datalenM + 1, datalenM + 1))
                                ...
                                if (exefsSizeM > 0):
                                    for i in range(exefsSizeM):
                                        ...
                                        print("\rPartition %1d ExeFS: Encrypting: %4d / %4d mb" % (
                                        p, i, exefsSizeM + 1), end="")
                                if (exefsSizeB > 0):
                                    g.write(exefsctrmode2C.encrypt(f.read(exefsSizeB)))
                                print("\rPartition %1d ExeFS: Encrypting: %4d / %4d mb... Done" % (
                            ...
                            if (romfs_off[0] != 0):
                                ...
                                if (romfsSizeM > 0):
                                    for i in range(romfsSizeM):
                                        ...
                                        print("\rPartition %1d RomFS: Encrypting: %4d / %4d mb" % (
                                        p, i * romfsBlockSize, romfsSizeTotalMb), end="")
                                if (romfsSizeB > 0):
                                    g.write(romfsctrmode.encrypt(f.read(romfsSizeB)))

                                print("\rPartition %1d RomFS: Encrypting: %4d / %4d mb... Done" % (
